...
def calculate_area_triangle(x, y):
    area = (x*y) /2
    return area
print('Exercise 1:', calculate_area_triangle(7, 5))
...
def convert_temperature(x,y):
    if y == 'C':
        ...
        return ('please input a correct scale')
...
print('Exercise 5:', sum_to(123456))
...
print('Exercise 6:', largest(63, 82, 4))
...
def calculate_tip(z,x):
    percent = (x/100)
    tip_ammount = z *percent
    return tip_ammount


print('Exercise 7:', calculate_tip(7268, 20.8752525))
